...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text=_["PL_B_12"], url=f"https://t.me/Bostat_1/4054"
            ),
        ],
        [    
            InlineKeyboardButton(
                text=_["PL_B_13"], url=f"https://t.me/TR_E2S_ON_MY_MOoN"
            ),
        ],        
        [
            InlineKeyboardButton(
                text=_["PL_B_3"], url=f"https://t.me/Kllllllllbot?startgroup=true",
            ),
        ],
    ]
    return buttons
