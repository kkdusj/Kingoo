...
def reply_to_HEY(Client, message):
    message.reply_photo(
        photo=f"https://t.me/source_av",
        caption=f"""[لـطـلـب ســورس مـيـوزك خـاص بــك او مــيـزه في ســورس مـيـوزك لا تـتـردد فـي الـتـواصـل مـعـي مـن خـلال الـزر فـي الأسـفـل ♬♪](https://t.me/TR_E2S_ON_MY_MOoN)""",
        reply_markup=InlineKeyboardMarkup(
            [
            [
                InlineKeyboardButton("𓆩🔻︙قـنـاة الـسـورس︙🔺️ 𓆪", url=f"https://t.me/source_av"),
                InlineKeyboardButton("𓆩👨‍💻︙مطور الـسـورس 𓆪", url=f"https://t.me/TR_E2S_ON_MY_MOoN"),
            ]
         ]
     )
  )
...
@app.on_message(filters.regex("₍ 𝑘 𝑖 𝑛 𝑔 || كـ ٖ ـيـنــج ⁾ ↺"))
def reply_to_HEY(Client, message):
    message.reply_photo(
        photo=f"https://t.me/TR_E2S_ON_MY_MOoN",
        caption=f"""[مــبـرمـج كـوكـبـه - افاتار - 🔥](https://t.me/TR_E2S_ON_MY_MOoN)""",
