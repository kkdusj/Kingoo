...
@app.on_message(
    command(["مميزات","افاتار"])
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ  ❁ ميوزك\n
⩹━★⊷⌯𝙎𝙊𝙐𝙍𝘾𝞝𖢻𝘼𝙑𝘼𝙏𝘼𝙍⌯⊶★━⩺

★قايمه مميزات سورس ❁ ᥲ️᥎ᥲ️ƚᥲ️ᖇ  ❁ 
